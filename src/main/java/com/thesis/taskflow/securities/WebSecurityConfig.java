package com.thesis.taskflow.securities;
...
//    private PasswordEncoder passwordEncoder;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v1/login", "/api/v1/users", "/ws/**", "/api/v1/login/oauth2/google","/swagger-ui.html","/swagger-ui/*","/v2/api-docs","/swagger-resources/**","/webjars/**","favicon.ico").permitAll()
